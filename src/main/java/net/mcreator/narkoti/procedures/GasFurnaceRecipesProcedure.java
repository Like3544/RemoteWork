...
public class GasFurnaceRecipesProcedure {
	public static double execute(LevelAccessor world, double x, double y, double z) {
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == NarkotiModBlocks.ELECTRIC_GAS_FURNACE.get()) {
			if ((new Object() {
			...
			}.getItemStack(world, BlockPos.containing(x, y, z), 0)).getItem() == Items.PRISMARINE_CRYSTALS) {
				return 2;
			} else if ((new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
			...
			}.getItemStack(world, BlockPos.containing(x, y, z), 1)).getItem() == Items.PRISMARINE_CRYSTALS) {
				return 2;
			} else if ((new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
