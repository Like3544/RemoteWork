...
public class RedstoneBatteryOnBlockRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity.getCapability(NarkotiModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new NarkotiModVariables.PlayerVariables())).AltMode) {
			...
			if (entity instanceof Player _player && !_player.level().isClientSide())
				_player.displayClientMessage(Component.literal(("\u042D\u043D\u0435\u0440\u0433\u0438\u044F: " + (new Object() {
				...
				}.getEnergyStored(world, BlockPos.containing(x, y, z))) + " FE")), true);
		}
	}
}
